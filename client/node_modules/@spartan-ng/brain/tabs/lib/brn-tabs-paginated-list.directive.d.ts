...
export declare abstract class BrnTabsPaginatedListDirective implements AfterContentChecked, AfterContentInit, AfterViewInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<BrnTabsPaginatedListDirective, never, never, { "disablePagination": { "alias": "disablePagination"; "required": false; "isSignal": true; }; }, { "selectFocusedIndex": "selectFocusedIndex"; "indexFocused": "indexFocused"; }, never, never, true, never>;
}
